...
public class TimeFormatting {
    ...
    public void start() {
        ...
        comboBox.addActionListener(
            actionEvent -> onComboBoxChanged(comboBox, actionEvent));
        
        // Timer periodically (with the interval of 1 sec) updates the current time
        Timer timer = new Timer(1000, 
            actionEvent -> updateCurrentTime(label, comboBox));
        timer.start();
    ...
    private JComboBox<String> createComboBox() {
        DefaultComboBoxModel<String> model = 
            new DefaultComboBoxModel<>(DATE_TIME_PATTERNS);
    ...
    private void onComboBoxChanged(JComboBox<String> comboBox,
    ...
    private void updateCurrentTime(JLabel label, JComboBox<String> comboBox) {
        ...
        if (selectedFormat != null) {
            SimpleDateFormat dateFormat = 
                new SimpleDateFormat(selectedFormat, Locale.US);
